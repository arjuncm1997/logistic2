...
class Materials(db.Model):
    ...
    sownerid = db.Column(db.String)
    uownerid = db.Column(db.String)
    ...
    netprice = db.Column(db.String(220))
    gst = db.Column(db.String(220))
    gstprice = db.Column(db.String(220))
    timeoffer = db.Column(db.String(220),default='no')

    def __repr__(self):
        return f"Materials('{self.name}', '{self.brand}','{self.avail}', '{self.price}','{self.image}')"

class Cartmaterials(db.Model):
    id = db.Column(db.Integer,primary_key=True)
    sowner = db.Column(db.String)
    uowner = db.Column(db.String)
    sownerid = db.Column(db.String)
...
class Timeoffer(db.Model):
    id = db.Column(db.Integer,primary_key=True)
    name = db.Column(db.String)
    date = db.Column(db.String,default='2025-03-10')
